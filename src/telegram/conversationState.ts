...
export type ConversationState = {
    action: 'ADD_CLIENT' | 'SEARCH_CLIENT' | 'ADD_PRODUCT' | 'ADD_PAYMENT' | 'ADD_ORDER' | 'ADD_COMMENT' | 'EDIT_ORDER_ITEM_QTY' | 'EDIT_PAYMENT_AMOUNT' | 'EDIT_CLIENT_NAME' | 'EDIT_CLIENT_PHONE' | 'EDIT_CLIENT_ADDRESS' | 'EDIT_PRODUCT_NAME' | 'EDIT_PRODUCT_PRICE' | null;
    data?: any;
